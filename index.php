...
<div id="main-row" class="row-fluid">
    ...
    <div id="content-wrap" class="pull-left span8">
        <?php do_action('alienship_content_title'); ?>
        <div id="content" role="main" class="<?php echo apply_filters('alienship_content_container_class', 'was_span9'); ?>">
            <?php
            if (have_posts()) :

                if (of_get_option('alienship_content_nav_above'))
                {
                    alienship_content_nav('nav-above');
                } // display content nav above posts?
